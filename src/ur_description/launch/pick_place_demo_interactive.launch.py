...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_node = None
    if launch_rviz:
        rviz_config_path = PathJoinSubstitution([FindPackageShare("ur_description"), "rviz", "pick_place_interactive.rviz"])
        rviz_node = Node(
            package="rviz2",
            executable="rviz2",
            name="rviz2",
    ...
    pick_place_node = Node(
        ...
        executable="pick_place_demo_interactive",
        name="pick_place_demo_interactive",
        output="screen",
        parameters=[
            robot_description,
            robot_description_semantic,
